...
describe('colorToTailwindClass', () => {
  ...
  test('HSLA color input - Tailwind colors', () => {
    ...
    expect(colorToTailwindClass('hsla(167, 87%, 30%, 1)')).toEqual('emerald-600');
    expect(colorToTailwindClass('hsla(213, 82%, 60%, 1)')).toEqual('blue-500');
    expect(colorToTailwindClass('hsla(251, 88%, 63%, 1)')).toEqual('indigo-500');
  ...
  test('HSLA color input - Common non-Tailwind colors', () => {
    ...
    expect(colorToTailwindClass('hsla(45, 100%, 91%, 1)')).toEqual('orange-100');
    expect(colorToTailwindClass('hsla(39, 100%, 85%, 1)')).toEqual('orange-200');
    expect(colorToTailwindClass('hsla(0, 100%, 25%, 1)')).toEqual('red-900');
    expect(colorToTailwindClass('hsla(240, 100%, 98%, 1)')).toEqual('violet-50');
  });
  ...
  test('RGBA color input - Common non-Tailwind colors', () => {
    ...
    expect(colorToTailwindClass('rgba(255, 218, 185, 1)')).toEqual('orange-200');
    expect(colorToTailwindClass('rgba(128, 0, 0, 1)')).toEqual('red-900');
    expect(colorToTailwindClass('rgba(230, 230, 250, 1)')).toEqual('indigo-100');
  });
